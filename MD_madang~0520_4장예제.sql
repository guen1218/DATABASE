...
-- [질의 4-3] 고객별 평균 주문금액을 백 원 단위로 반올림하여 구하시오.
...
-- [질의 4-7] 마당서점은 주문일로부터 10일 후 매출을 확정한다. 각 주문의 확정일을 구하시오.
...
-- [질의 4-20] 주소에 ‘대한민국’을 포함하는 고객들로 구성된 뷰를 만들고 조회하시오. 뷰의 이름은 vw_ Customer로 한다.
...
-- [질의 4-21] 고객 이름과 도서 이름을 함께 확인할 수 있는 뷰를 생성하고, ‘김연아’ 고객이 구입한 도서의 주문번호, 도서명, 주문금액을 조회하시오.
...
--[질의 4-22] [질의 4-20]에서 생성한 뷰 vw_Customer는 주소에 ‘대한민국’이 포함된 고객을 보여 준다. 이 뷰를 수정하여 ‘영국’이 포함된 고객만 보여주고, phone 속성은 제외하시오.
